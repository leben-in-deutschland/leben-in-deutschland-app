...
export default function PrivacyPolicy() {
    return (
        <Card className="flex flex-col items-center justify-center gap-8 py-8 md:py-12 lg:py-16">
            <CardHeader className="flex flex-col text-center text-3xl font-bold text-foreground">
                <span><span className="text-primary">lebenindeutschland.org / Einbürgerungstest </span>Privacy Notice</span>
                <div className="mt-2 text-lg text-default-500">Last updated January 30, 2025</div>
            </CardHeader>
            <div className="w-full md:w-3/4 lg:w-1/2 px-6 py-4 rounded-lg shadow-md mb-8 text-center">
                ...
                <ul className="space-y-2">
                    ...
                    <li><a href="#info-collection" className="text-primary hover:underline">2. Information We Collect</a></li>
                    <li><a href="#data-ownership" className="text-primary hover:underline">3. Data Ownership & Control</a></li>
                    <li><a href="#third-party" className="text-primary hover:underline">4. Third-Party Services</a></li>
                    <li><a href="#changes" className="text-primary hover:underline">5. Changes to This Privacy Policy</a></li>
                    <li><a href="#contact" className="text-primary hover:underline">6. Contact Us</a></li>
                </ul>
            </div>
            ...
            <CardBody className="flex flex-col gap-8">
                <Card id="intro" className="shadow-md rounded-lg">
                    ...
                    <div className="p-6 text-foreground">
                        <p>Thank you for choosing to be part of our community at Lamplit Labs, doing business as lebenindeutschland.org/Einbürgerungstest (&quot;lebenindeutschland&quot;,&quot;Einbürgerungstest&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). We are committed to protecting your personal information and respecting your right to privacy. If you have any questions or concerns about this privacy notice or our practices regarding your personal information, please contact us at hello@lamplitlabs.com.</p>
                    </div>
                </Card>
                ...
                <Card id="contact" className="shadow-md rounded-lg">
                    ...
                    <div className="p-6 text-foreground">
                        <p>If you have any questions about this privacy policy or our practices, or if you wish to exercise any of your rights regarding your data, please feel free to contact us at hello@lamplitlabs.com. We will respond to your inquiries in a timely manner.</p>
                    </div>
                </Card>
            </CardBody>
        </Card>
