...
export default function PrivacyPolicy() {
    return (
        <Card className="flex flex-col items-center justify-center gap-8 py-8 md:py-12 lg:py-16 bg-gray-50">
            ...
            <div className="w-full md:w-3/4 lg:w-1/2 px-6 py-4 bg-white rounded-lg shadow-md mb-8">
            ...
            <CardBody className="flex flex-col gap-8">
                <Card id="intro" className="bg-white shadow-md rounded-lg">
                ...
                <Card id="info-collection" className="bg-white shadow-md rounded-lg">
                    <CardHeader className="bg-indigo-600 text-white py-3 rounded-t-lg">
                ...
                <Card id="data-ownership" className="bg-white shadow-md rounded-lg">
                    <CardHeader className="bg-indigo-600 text-white py-3 rounded-t-lg">
                ...
                <Card id="third-party" className="bg-white shadow-md rounded-lg">
                    <CardHeader className="bg-indigo-600 text-white py-3 rounded-t-lg">
                ...
                <Card id="changes" className="bg-white shadow-md rounded-lg">
                    <CardHeader className="bg-indigo-600 text-white py-3 rounded-t-lg">
                ...
                <Card id="contact" className="bg-white shadow-md rounded-lg">
                    <CardHeader className="bg-indigo-600 text-white py-3 rounded-t-lg">
